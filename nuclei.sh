...
nuclei_output="report.nuclei.${timestamp}.txt"
...
httpx -silent -l "$input_file" | nuclei -et "$exclude_templates" -o "$nuclei_tmp_output" -v -page-timeout 3 -timeout 3 -concurrency 50 -bulk-size 50 -rate-limit 500
